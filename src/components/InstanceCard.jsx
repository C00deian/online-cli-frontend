...
export default function InstanceCard({ plan, onCreate, loading }) {
  return (
    <div className="rounded-xl p-6 transition bg-white shadow-[4px_4px_20px_rgba(0,0,0,0.1)] hover:shadow-[10px_10px_30px_rgba(0,0,0,0.15)] hover:scale-[1.02]">
      <div className="text-[clamp(1rem,1vw,2rem)] font-semibold mb-4 whitespace-nowrap text-center">
        {plan.label}
      </div>
      ...
      <button
        ...
        className="mt-2 w-full bg-gray-800 text-white py-2 rounded hover:bg-gray-700 transition cursor-pointer"
        disabled={loading}
      >
